...
import { InscriptionEvenementComponent } from 'app/entities/inscription-evenement/inscription-evenement.component';
...
describe('Component Tests', () => {
  describe('InscriptionEvenement Management Component', () => {
    let comp: InscriptionEvenementComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(InscriptionEvenementComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new InscriptionEvenement(123)],
            headers,
          })
        )
      );
      ...
      expect(comp.inscriptionEvenements && comp.inscriptionEvenements[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
