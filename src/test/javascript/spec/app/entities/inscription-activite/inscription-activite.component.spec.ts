...
import { InscriptionActiviteComponent } from 'app/entities/inscription-activite/inscription-activite.component';
...
describe('Component Tests', () => {
  describe('InscriptionActivite Management Component', () => {
    let comp: InscriptionActiviteComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(InscriptionActiviteComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new InscriptionActivite(123)],
            headers,
          })
        )
      );
      ...
      expect(comp.inscriptionActivites && comp.inscriptionActivites[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
