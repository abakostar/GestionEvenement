...
Edit [src/main/webapp/app/vendor.ts](src/test/app/vendor.ts) file:
...
To build the final jar and optimize the gestionevenementapp application for production, run:
